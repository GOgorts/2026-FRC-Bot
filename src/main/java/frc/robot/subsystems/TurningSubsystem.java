...
private SparkMax turningMotor =
    new SparkMax(turningMotorCanID, MotorType.kBrushless);
    ...
    public Command runTurningCommand() {
            ...
            return this.startEnd(
                () -> this.setTurningPower(TurningSetpoints.kturnForawrd), () -> this.setTurningPower(0.0));
    ...
    public Command reverseTurningCommand() {
            ...
            return this.startEnd(
                () -> this.setTurningPower(TurningSetpoints.ktunReverse), () -> this.setTurningPower(0.0));
